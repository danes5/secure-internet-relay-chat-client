...
QT_MOC_LITERAL(7, 65, 13), // "channelRemove"
QT_MOC_LITERAL(8, 79, 11), // "sendMessage"
QT_MOC_LITERAL(9, 91, 7), // "message"
QT_MOC_LITERAL(10, 99, 9) // "readyRead"

    },
    "Channel\0onMessageReceived\0\0text\0"
    "otherClient\0onChannelActive\0name\0"
    "channelRemove\0sendMessage\0message\0"
    "readyRead"
};
...
void Channel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->channelRemove((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (Channel::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Channel::channelRemove)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void Channel::channelRemove(QString _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
