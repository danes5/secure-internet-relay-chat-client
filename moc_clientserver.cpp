...
QT_MOC_LITERAL(1, 13, 24), // "incomingConnectionSignal"
QT_MOC_LITERAL(2, 38, 0), // ""
QT_MOC_LITERAL(3, 39, 8), // "quintptr"
QT_MOC_LITERAL(4, 48, 16) // "socketDescriptor"

    },
    "ClientServer\0incomingConnectionSignal\0"
    "\0quintptr\0socketDescriptor"
};
...
void ClientServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->incomingConnectionSignal((*reinterpret_cast< quintptr(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (ClientServer::*_t)(quintptr );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ClientServer::incomingConnectionSignal)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ClientServer::staticMetaObject = {
    { &QTcpServer::staticMetaObject, qt_meta_stringdata_ClientServer.data,
      qt_meta_data_ClientServer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void ClientServer::incomingConnectionSignal(quintptr _t1)
{
