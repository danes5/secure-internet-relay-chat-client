...
QT_MOC_LITERAL(1, 11, 18), // "forwardSendMessage"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 13), // "communication"
QT_MOC_LITERAL(4, 45, 4), // "text"
QT_MOC_LITERAL(5, 50, 25), // "forwardStartCommunication"
QT_MOC_LITERAL(6, 76, 10), // "clientName"
QT_MOC_LITERAL(7, 87, 23), // "forwardRegisterToServer"
...
QT_MOC_LITERAL(36, 579, 14), // "channelDeleted"
QT_MOC_LITERAL(37, 594, 19) // "leaveChannelPressed"

    },
    "MainWindow\0forwardSendMessage\0\0"
    "communication\0text\0forwardStartCommunication\0"
    ...
    "channelCreated\0quitPressed\0channelDeleted\0"
    "leaveChannelPressed"
};
...
void MainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->forwardSendMessage((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 1: _t->forwardStartCommunication((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->forwardRegisterToServer((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        case 25: _t->channelDeleted((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 26: _t->leaveChannelPressed(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainWindow::forwardSendMessage)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainWindow::forwardStartCommunication)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (MainWindow::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainWindow::forwardRegisterToServer)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainWindow::onRefreshButtonPressed)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (MainWindow::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainWindow::onChannelRequestAccepted)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (MainWindow::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainWindow::onChannelRequestDeclined)) {
                *result = 5;
                return;
            }
        }
...
// SIGNAL 0
void MainWindow::forwardSendMessage(QString _t1, QString _t2)
{
...
// SIGNAL 1
void MainWindow::forwardStartCommunication(QString _t1)
{
...
// SIGNAL 2
void MainWindow::forwardRegisterToServer(QString _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 4
void MainWindow::onChannelRequestAccepted()
{
