...
public:
  ...
  /**
   * @brief encryptRegistrationRequest encrypt registration request using
   * symetric key
  ...
  /**
   * @brief encryptCreateChannelRequest encrypt create channel request using
   * symetric key
  ...
  /**
   * @brief encryptCreateChannelReply encrypt create channel reply using
   * symetric key
   * @param clientName name of other client
   * @param clientName name of other client
  ...
  /**
   * @brief encryptGetActiveClientsRequest encrypt request to get list of active
   * clients
   * @return encrypted message
   */
  ...
  /**
   * @brief encryptSendSymKey encrypt request to set symetric key using
   * asymetric key
   * @return encrypted message
   */
  ...
  /**
   * @brief sendCreateChannelReply sends encrypted reply to create channel
   * request
  ...
  /**
   * @brief sendGetActiveClientsRequest sends encrypted request to get active
   * clients
   */
  ...
  /**
   * @brief connectToServer securely connects to the server and sets
   * certificates etc.
   */
...
public slots:
  ...
  /**
   * @brief connected slot called after connection to server has been
   * established
   */
  void connected();
...
signals:
  /**
   * @brief onRegistrationReply signal emmited after registration reply was
   * received
  ...
  /**
   * @brief onUpdatedActiveClients signal emmited after new list of active
   * clients was received
   * @param clients list of clients
   */
  void onUpdatedActiveClients(QJsonArray clients);

  /**
   * @brief onRequestReceived signal emmited after request for communication was
   * received
  ...
  /**
   * @brief onChannelReplyReceived signal emmited after reply for communication
   * was received
   * @param clInfo info about sender
